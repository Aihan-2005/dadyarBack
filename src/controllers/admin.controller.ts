...
export class AdminController {
  ...
  public createLawyer = async (
    ...
    try {
      const input = AdminCreateLawyerSchema.parse(req.body ?? {});

      const lawyer = await this.adminService.createLawyer(input);
  ...
  public listClientLawyers = async (
    _req: Request,
    ...
    try {
      const placements = await this.adminService.listClientLawyerPlacements();
  ...
  public publishClientLawyer = async (
    req: Request,
    ...
    try {
      ...
      const input = AdminPublishClientLawyerSchema.parse(req.body ?? {});

      const placement = await this.adminService.publishLawyerToClientDirectory(
        id,
        input,
      );
  ...
  public updateClientLawyer = async (
    req: Request,
    ...
    try {
      ...
      const input = AdminUpdateClientLawyerSchema.parse(req.body ?? {});

      const placement = await this.adminService.updateClientLawyerPlacement(
        id,
        input,
      );
  ...
  public removeClientLawyer = async (
    req: Request,
    ...
    try {
      ...
      await this.adminService.removeLawyerFromClientDirectory(id);
