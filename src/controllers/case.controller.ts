    ...
    > => {
      try {
        ...
        const {
          ...
          ParamCaseAndOpposingPartyIdSchema.parse(
            req.params
          );

        const opposingParty =
          UpdateOpposingPartySchema.parse(
            req.body ??
              {}
          );
  ...
  public addAssistantLawyer =
    ...
    > => {
      try {
        ...
        const assistantLawyer =
          AddAssistantLawyerSchema.parse(
            req.body ??
              {}
          );
    ...
    > => {
      try {
        ...
        const {
          ...
          ParamCaseAndAssistantLawyerIdSchema.parse(
            req.params
          );

        const assistantLawyer =
          UpdateAssistantLawyerSchema.parse(
            req.body ??
              {}
          );
  ...
  public addOpposingLawyer =
    ...
    > => {
      try {
        ...
        const opposingLawyer =
          AddOpposingLawyerSchema.parse(
            req.body ??
              {}
          );
    ...
    > => {
      try {
        ...
        const {
          ...
          ParamCaseAndOpposingLawyerIdSchema.parse(
            req.params
          );

        const opposingLawyer =
          UpdateOpposingLawyerSchema.parse(
            req.body ??
              {}
          );
    ...
    > => {
      try {
        ...
        const {
          ...
          ParamCaseAndRelatedPersonIdSchema.parse(
            req.params
          );

        const relatedPerson =
          UpdateRelatedPersonSchema.parse(
            req.body ??
              {}
          );
